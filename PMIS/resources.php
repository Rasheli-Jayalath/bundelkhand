...
<div id="content">
	  ...
	  <table width="100%" border="0"  align="center" cellpadding="1" cellspacing="1" style="padding-left:10px">
            <tr>
              <td valign="top"><table style="padding-top:10px">
             <tr>
            ...
            <tr>
              ...
              <td width="20%" colspan="2" > <?php $btemp="Select * from baseline_template where active_temp=1";
...
<li>3. In any case qunatity can be modified. </li>
            ...
            <tr>
              <td width="13%" class="label1">Baseline Item:</td>
              <td colspan="2" >
                <div id="baselinediv">
...
?>
                ...
                <tr <?php echo $style; ?>>
                  ...
                  <td><input class="checkbox" type="checkbox" name="sel_checkbox[]" id="sel_checkbox[]" value="<?php echo $rid ?>"   form="reports" onclick="group_checkbox();" /></td>

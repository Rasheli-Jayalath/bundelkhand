...
<form name="reports" id="reports"  method="post"   style="display:inline-block; width:100%;margin-top:10px;"> 
	...
	{
	?>
		<a class="button" href="javascript:void(null);" onclick="window.open('subboq.php?milestone=1', 'Add Milestone','width=670px,height=550px,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=0,left=0,top=0');" >Add Milestone</a>
		<?php
		}
		?>
...
<div id="without_search">
	...
	{
	?>
      <th align="center" width="50%"><strong>Name</strong></th>
	  <?php
	  }
	  else
	  {
	  ?>
	   <th align="center" width="70%"><strong>Name</strong></th>
	  <?php
	  }
	  ?>
	 <!-- <th align="center" width="5%"><strong>Stage</span></strong></th>-->
	  <th align="center" width="10%"><strong>Code</strong></th>
	...
	{
	?>
	   <th align="center" width="30%"><strong>Action
     </strong></th>
	 <?php
	 }
	 ?>
...
function AddNewSizeProject<?php echo $itemid; ?>(){
	...
	doAddTr(arrTds, 'tblPrdSizesProject<?php echo $itemid; ?>');
		...
		{
		$editlink='boq.php?milestone=1';
		$redirect="subboq.php?subaid=$itemid&levelid=$activitylevel&milestone=1";
		$redirect_title="Add SubMilestone";
		}
		else if($stage=='BOQ' && $activitylevel>0)
		{
		$editlink='subboq.php?milestone=1';
		$redirect="subboq.php?subaid=$itemid&levelid=$activitylevel&milestone=1";
		$redirect_title="Add SubMilestone";
		}
		...
		{
		?>
		 | <a href="<?php echo $deletelink; ?>?del=<?php echo $itemid;?>"   onclick="return confirm('Are you sure you want to delete this Milestone and all of its child?')">Delete</a><?php } } ?>
			 ...
			 ?>
		 <td style=" font-size:10px;  color: #000000; background-color: <?php echo $colorr; ?>" >
		 <a href="logboq.php?trans_id=<?php echo $itemid ; ?>&module=<?php echo $module?>" >Log</a>

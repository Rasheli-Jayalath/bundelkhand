...
if($item!="")
{
 $sqlgx="Select itemname, parentcd from maindata where stage='CAM'  and activitylevel=2 and itemid=$item";
        	...
        	<tr>
			 ...
			 {?>
			  ...
			  <select name="txtoutput" >
			   <option value="">Select</option>
			  <?php $sqlop="Select * from maindata where stage='CAM' and activitylevel=2";

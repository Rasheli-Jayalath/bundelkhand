...
function GetActivity(){
	...
	document.location = 'CAM_progress_dashboard.php?' + qString;
}
</script>
</head>
<body>
...
<tr> 
<td width="20%" align="left" valign="top" style="border-right: solid 1px #ccc;background-color:#f8f8f8;"><div id="wrapper_MemberLogin" style="margin:10px">
  <h1 style="color:#333;"><?php echo "CAM Monitoring Dashboard";?> </h1>
  <div class="clear"></div>
  <div id="LoginBox" class="borderRound borderShadow" style="padding:10px">
    <form action="KPI_progress_dashboard.php" method="post" name="main_dash" id="main_dash" onsubmit="return frmValidate1(this);">
      <table border="0px" cellpadding="0px" cellspacing="0px" align="center"  >
        <tr>
          <td ><strong>
            <label>Main CAM</label>
          </strong></td>
          <td><div id="str_obj_div">
            <select name="str_obj" id="str_obj" onchange="GetActivity()">
             <option value="0">Select Main CAM..</option>
              <?php
				$str_g_query = "select * from maindata where stage='CAM' and activitylevel=0 ";
          ...
          <td><div id="outcome_div">
            <select name="outcome_id" id="outcome_id" onchange="GetActivity()">
              <option value="0">Select Sub Main..</option>
               <?php
				$outcome_query =  "select * from maindata where stage='CAM' and activitylevel=1 ";
        ...
        <tr>
          ...
          <td><div id="output_div">
            ...
            <option value="0">Select Output..</option>
             <?php
				$output_query =  "select * from maindata where stage='CAM' and activitylevel=2 ";
        ...
        <td>
           ...
           <select name="act_id" id="act_id" onchange="GetActivity()">
            <option value="0">Select Activity..</option>
             <?php
				$activity_query ="select * from maindata where stage='CAM' and activitylevel=3 ";
...
<script src="highcharts/js/modules/jquery.highchartTable.js"></script>
 <?php include("includes/functions_cam.php");?>
...
<?php include("includes/cam_project_level.php");?>
<?php  include("includes/cam_components_level.php");?>
<?php  include("includes/cam_subcomponents_level.php");?>
<?php  include("includes/cam_data_level_progress_dashboard.php");?>
</td>
</tr>
</table>

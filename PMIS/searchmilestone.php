...
if($valuestage!="")
{
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (stage  like '%".$valuestage."%' and stage='Milestone') ";
		}
		else
		{
		$sCondition=" (stage  like '%".$valuestage."%' and stage='Milestone') ";
		}
...
if($valueitemcode!="")
{
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (itemcode  like '%".$valueitemcode."%' and stage='Milestone') ";
		}
		else
		{
		$sCondition=" (itemcode  like '%".$valueitemcode."%' and stage='Milestone') ";
		}
...
if($valueitemname!="")
{
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (itemname  like '%".$valueitemname."%' and stage='Milestone') ";
		}
		else
		{
		$sCondition=" (itemname  like '%".$valueitemname."%' and stage='Milestone') ";
		}
...
$valueisentry=0;
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (isentry=$valueisentry and stage='Milestone') ";
		}
		else
		{
		$sCondition=" (isentry=$valueisentry and stage='Milestone') ";
		}
...
if (strpos($valueweight,'-') === 0) {
	...
	$sCondition.=" AND (weight <= '$expstart' and stage='Milestone') ";
	}
	else
	{
	$sCondition= " (weight  <= '$expstart' and stage='Milestone') ";
	}
} 
	...
	if($sCondition!="")
	{
	$sCondition.=" AND (weight between ".$expstart." and ".$expend." and stage='Milestone') ";
	}
	else
	{
	$sCondition= " (weight between ".$expstart." and ".$expend." and stage='Milestone') ";
	}
}	
}
}
...
if($sCondition=="")
{
$sCondition="1=1 and stage='Milestone'";
}
if($module=="Milestone Data")
{
...
<td style=" font-size:10px;  color: #000000; background-color: <?php echo $colorr; ?>" >&nbsp;
		...
		?>
<td style=" font-size:10px; color: #000000; background-color: <?php echo $colorr; ?>" ><a href="logmilestone.php?trans_id=<?php echo $id1; ?>&module=<?php echo $module?>">Log</a></td>
</tr>
<tr>
		<td colspan="9">
			 <?php

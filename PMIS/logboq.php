...
$objDb->query($sSQL1);
?>
<h1>Log (<?php echo $module; ?>)<span style="text-align:right; float:right"><a href="boqdata.php">Back</a></span></h1>
<table class="allformat" width="100%" align="center" cellpadding="1" cellspacing="0" border="1"  >
 ...
 <?php if($module=="BOQ Data"){ ?><td><strong>Stage<strong/></td><td><strong>Item Code<strong/></td><td><strong>Item Name<strong/></td><td><strong>Is Entry<strong/></td><?php } ?>

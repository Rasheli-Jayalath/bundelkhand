...
$parentcd=0;	
$sSQL = ("INSERT INTO maindata (parentcd,  stage,itemcode,itemname, weight) VALUES ($parentcd, '$txtstage','$txtitemcode', '$txtitemname',$txtweight)");
	$objDb->execute($sSQL);
...
var itemcode=document.frmstgoal.txtitemcode.value;  
var itemname=document.frmstgoal.txtitemname.value;
var weight=document.frmstgoal.txtweight.value;   
...
<input type="text" name="valueitemcode"  id="valueitemcode"  title="Strategic Goal Code" placeholder="Strategic Goal Code" style="width:150px"    onkeyup="showResult(module.value,this.value,valueitemname.value,valueweight.value,valueisentry.value)" width="400px"/>
<input type="text" name="valueitemname"  id="valueitemname" title="Strategic Goal Name" placeholder="Strategic Goal Name" style="width:150px"    onkeyup="showResult(module.value,valueitemcode.value,this.value,valueweight.value,valueisentry.value)"/>
...
<div id="search"></div>
    ...
    <tr bgcolor="#333333" style="text-decoration:inherit; color:#CCC">
     ...
     <th align="center" width="10%"><span class="label">Strategic Goal Code</span></th>
	 <th align="center" width="15%"><span class="label">Strategic Goal  Name</span></th>
...
<strong>
<?php
 $sSQL = " Select * from maindata where stage='Strategic Goal'";
 $objDb->query($sSQL);
...
<td style="border-bottom:1px solid #cccccc" width="210px" >&nbsp;
 <a href="strategic_goal.php?edit=<?php echo $itemid;?>" ><img src="images/edit.png" width="22" height="22"/></td>

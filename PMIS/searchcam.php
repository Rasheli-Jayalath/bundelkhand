...
if($valuestage!="")
{
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (stage  like '%".$valuestage."%' and stage='CAM') ";
		}
		else
		{
		$sCondition=" (stage  like '%".$valuestage."%' and stage='CAM') ";
		}
...
if($valueitemcode!="")
{
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (itemcode  like '%".$valueitemcode."%' and stage='CAM') ";
		}
		else
		{
		$sCondition=" (itemcode  like '%".$valueitemcode."%' and stage='CAM') ";
		}
...
if($valueitemname!="")
{
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (itemname  like '%".$valueitemname."%' and stage='CAM') ";
		}
		else
		{
		$sCondition=" (itemname  like '%".$valueitemname."%' and stage='CAM') ";
		}
...
$valueisentry=0;
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (isentry=$valueisentry and stage='CAM') ";
		}
		else
		{
		$sCondition=" (isentry=$valueisentry and stage='CAM') ";
		}
...
if (strpos($valueweight,'-') === 0) {
	...
	$sCondition.=" AND (weight <= '$expstart' and stage='CAM') ";
	}
	else
	{
	$sCondition= " (weight  <= '$expstart' and stage='CAM') ";
	}
} 
	...
	if($sCondition!="")
	{
	$sCondition.=" AND (weight between ".$expstart." and ".$expend." and stage='CAM') ";
	}
	else
	{
	$sCondition= " (weight between ".$expstart." and ".$expend." and stage='CAM') ";
	}
}	
}
}
...
?>
	...
	?>
		...
		?>
<td style=" font-size:10px; color: #000000; background-color: <?php echo $colorr; ?>" ><a href="logcam.php?trans_id=<?php echo $id1; ?>&module=<?php echo $module?>" target="_blank">Log</a></td>
</tr>
<tr>
		<td colspan="9">
			 <?php

...
if($valuestage!="")
{
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (stage  like '%".$valuestage."%' and (stage='Strategic Goal' || stage='Outcome' || stage='Output' || stage='Activity')) ";
		}
		else
		{
		$sCondition=" (stage  like '%".$valuestage."%' and (stage='Strategic Goal' || stage='Outcome' || stage='Output' || stage='Activity')) ";
		}
...
if($valueitemcode!="")
{
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (itemcode  like '%".$valueitemcode."%' and (stage='Strategic Goal' || stage='Outcome' || stage='Output' || stage='Activity')) ";
		}
		else
		{
		$sCondition=" (itemcode  like '%".$valueitemcode."%' and (stage='Strategic Goal' || stage='Outcome' || stage='Output' || stage='Activity')) ";
		}
...
if($valueitemname!="")
{
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (itemname  like '%".$valueitemname."%' and (stage='Strategic Goal' || stage='Outcome' || stage='Output' || stage='Activity')) ";
		}
		else
		{
		$sCondition=" (itemname  like '%".$valueitemname."%' and (stage='Strategic Goal' || stage='Outcome' || stage='Output' || stage='Activity')) ";
		}
...
$valueisentry=0;
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (isentry=$valueisentry and (stage='Strategic Goal' || stage='Outcome' || stage='Output' || stage='Activity')) ";
		}
		else
		{
		$sCondition=" (isentry=$valueisentry and (stage='Strategic Goal' || stage='Outcome' || stage='Output' || stage='Activity')) ";
		}
...
if (strpos($valueweight,'-') === 0) {
	...
	$sCondition.=" AND (weight <= '$expstart' and (stage='Strategic Goal' || stage='Outcome' || stage='Output' || stage='Activity')) ";
	}
	else
	{
	$sCondition= " (weight  <= '$expstart' and (stage='Strategic Goal' || stage='Outcome' || stage='Output' || stage='Activity')) ";
	}
} 
	...
	if($sCondition!="")
	{
	$sCondition.=" AND (weight between ".$expstart." and ".$expend." and (stage='Strategic Goal' || stage='Outcome' || stage='Output' || stage='Activity')) ";
	}
	else
	{
	$sCondition= " (weight between ".$expstart." and ".$expend." and (stage='Strategic Goal' || stage='Outcome' || stage='Output' || stage='Activity')) ";
	}
}	
}
}
...
<body>
 <div class="with_search">
	...
	?>	  
	  ...
	  {
	  ?>
	   <th align="center" width="40%"><strong>Resource Name</strong></th>
	   <?php
	  }
	  ?> 	
...
if($sCondition=="")
{
$sCondition="1=1 and (stage='Strategic Goal' || stage='Outcome' || stage='Output' || stage='Activity')";
}
if($module=="Main Data")
{
...
<tr>
	...
	<div id="abc<?php echo $itemid; ?>"> 
			...
			<?php  if($mdataentry_flag==1 || $mdataadm_flag==1)
			 ...
			 <a onClick="AddNewSizeProject<?php echo $itemid; ?>();" href="javascript:void(null);">Add New</a></div><?php }
			 ?>
...
?>
<td width="210px" align="right" ><a href="log.php?trans_id=<?php echo $id1; ?>&module=<?php echo $module?>" >Log</a></td>
</tr>

...
else
{
 ...
 $sSQL = ("INSERT INTO activity (itemid,  code,  secheduleid, startdate, enddate, actualstartdate, actualenddate, aorder,baseline, remarks,rid,weight) VALUES ($itemid,'$code', '$secheduleid','$startdate', '$enddate','$actualstartdate','$actualenddate',$aorder,$baseline,'$remarks',$rid,$weight)");
	$objDb->execute($sSQL);

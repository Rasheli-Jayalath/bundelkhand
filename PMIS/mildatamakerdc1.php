...
select ifnull(a1112.progressdate, a111.budgetdate), ifnull(a1112.itemid, a111.itemid), ifnull(a1112.rid, a111.rid), ifnull(a1112.progress,a111.progress), ifnull(a1112.comm_progress, a111.comm_progress), ifnull(a1112.temp_id, a111.temp_id) 

from 
 (SELECT '2018-06' as budgetdate, a11.itemid, a11.rid, 0 as progress, 0 as comm_progress, a11.temp_id FROM planned a11 WHERE left(a11.budgetdate,7) = '2018-06' group by a11.itemid, a11.rid) a111
...
left(a1.progressdate,7) = '2018-06' group by a1.itemid, a1.rid) A1112 on (a111.itemid = a1112.itemid and a111.rid=a1112.rid and a111.temp_id=a1112.temp_id)

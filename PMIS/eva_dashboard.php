...
$module		= "Earned value Analysis (EVA)";
...
<?php /*?><title><?php echo PROJECT;?></title><?php */?>
...
<div style="height:110px;background-color:#f8f8f8;text-align:center; min-width:6067px; width:auto">
<div class="wrap" style="margin:0px; padding:0px;min-width:2400px; width:auto">
<a href="./index.php"><img src="images/logo.png"   height="106" title="Home"  align="left" style="border-color:#ccc; border-radius:1px; padding:2px" /></a><div style="width:auto; padding-top:10px;text-align:center">
...
<span style="font-family:Arial, Helvetica, sans-serif; font-size:24px; color:#333; font-weight:bold; padding-left:302px" >Earned value Analysis (EVA) Dashboard</span>
</div>
</div></div>

...
if($subaid!="")
{
 $sqlgx="Select itemname, parentcd,parentgroup from kpidata where stage='KPI' and kpiid=$subaid";
  ...
  $eCount = $objDb->getCount();
	if($eCount > 0){
	  $parentgroup2 					= $objDb->getField(0,parentgroup);
	   $txtparentcd 					= $objDb->getField(0,kpiid);
	  }
   $sSQL = ("INSERT INTO kpidata (parentcd, activitylevel, stage,itemcode, itemname, weight, isentry, kpi_temp_id) VALUES ($txtparentcd,$kpilevel+1,'$txtstage','$txtitemcode', '$txtitemname',$txtweight,$txtisentry,'$kpi_temp_id')");
	$objDb->execute($sSQL);
...
<div id="content">
	  ...
	  <table width="100%" border="0"  align="center" cellpadding="1" cellspacing="1">
		   ...
		   {?>
            ...
            <tr>
              <td class="label">&nbsp;</td>
              <td class="label">SubKPI Code:</td>
              <td ><input id="txtitemcode" name="txtitemcode" type="text" value="<?php echo $itemcode; ?>"/></td>
             </tr>
			 <tr>
              <td class="label">&nbsp;</td>
              <td class="label">SubKPI  Name:</td>
              <td align="left"><input id="txtitemname" name="txtitemname" type="text" value="<?php echo $itemname; ?>" align="left"/></td>
             </tr>
			 
			 	<tr>
			  <td class="label">&nbsp;</td>
              <td class="label">SubKPI Weight:</td>
              <td >

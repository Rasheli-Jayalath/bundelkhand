...
<table  width="100%">
	...
	?>
			...
			<?php
			$sqlga="Select * from milestone_activity where activityid=$aid and milestoneid=$itemid";
	...
	{
	?><input type="button" value="Edit" name="edit" id="edit" onclick="edit_data(<?php echo $aid;?>,<?php echo $itemid;?>)"  /><?php
	}
	?></td>
			</tr>

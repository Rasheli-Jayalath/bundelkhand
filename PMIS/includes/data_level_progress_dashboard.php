...
while ($reportdata = mysql_fetch_array($reportresult)) {
	$i++;
					  ...
					  $total_work=$reportdata["baseline"];
...
$(function () {
            ...
            series: [
		{
				...
				echo "Actual: ";?><?php echo '<span style="color:blue">'.number_format(round($till_today_qty),0)." ".$unit.'</span>';?>',
			...
			,{
                name: 'Planned: <?php echo '<span style="color:blue">'.number_format($total_work,0).'</span>';?>',
                data: [
			...
			<?php /*?>,
			{ name: 'Total Work: <?php echo '<span style="color:blue">'.number_format($total_work,0).'</span>';?>',
			...
			,<?php */?>
			<?php /*?>{ name: 'Actual Work: <?php echo '<span style="color:blue">'.number_format(round($till_today_qty),0)." ".$unit.'</span>';?>',
			...
			,
			{ name: 'Current Work Rate (Per Day): <?php echo '<span style="color:blue">'.number_format(round($current_daily_rate),0)." ".$unit.'</span>';?>',
			  ...
			  marker: {
				...
				,
			{ name: 'Required Rate (Per Day): <?php echo '<span style="color:blue">'.number_format(round($require_daily_rate),0)." ".$unit.'</span>';?>',
			...
			if($projected_date!=""&& $projected_date!="1997-01-01" && $projected_date!="0000-00-00") 
			{
			  ...
			  marker: {
				...
				if($end_date!=""&& $end_date!="1997-01-01" && $end_date!="0000-00-00") 
			{
				echo '<span style="color:blue">'.date('d-M-Y',strtotime($end_date)).'</span>';
			}?>',
...
<tr>
  ...
  <th width="15" rowspan="2">Unit/Weight</th>
...
<!--  <th width="39" rowspan="2">Days Remaining</th>-->
  ...
  <th width="66" rowspan="2">Current Work Rate (Per Day)</th>
  <th width="66" rowspan="2">Required  Rate (Per Day)</th>

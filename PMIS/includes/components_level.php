...
$(function () {
        $('#container').highcharts({
            ...
            subtitle: {
                text: '<?php echo "Component Progress(".date('Y',strtotime($lastMonth)).")";?>'
            },
            xAxis: {
                type: 'datetime',
...
<td colspan="30" align="center"><span class="white"><strong><?php echo $pdata["pdetail"];?> (Component Level <?php echo date('Y',strtotime($lastMonth)); ?>)</strong></span></td>
</tr>
<tr>

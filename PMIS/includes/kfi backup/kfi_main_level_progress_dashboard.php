...
if($str_length_id<6 && $reportdata_act['boqid']!=0 && $reportdata_act['boqid']!="")
	{
    $ipcqty=getProgressAmountBOQ($reportdata_act['boqid']);
	}
    else
	{
...
$todate_amount3+=$reportdata_act['boq_cur_3_rate']*$reportdata_act['cur_3_exchrate']*$ipcqty;
	...
	if($str_length_id<6 && $reportdata_act['boqid']!=0 && $reportdata_act['boqid']!="")
	{
	$this_qty=getThisProgressAmountBOQ($reportdata_act['boqid'],$ipcid);
	}
	else
	{
...
if($str_length_id<6 && $reportdata_act['boqid']!=0 && $reportdata_act['boqid']!="")
	{
 $ipcqty=getProgressAmountIPCBOQ($rows2['boqid'],$rows['ipcid']);
	}
	else
	{

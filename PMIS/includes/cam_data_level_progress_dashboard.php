...
$latest_achieved=0;
$baseline=0;
$reportquery ="SELECT z.itemid,z.itemname, z.itemcode, z.parentcd,z.activitylevel,z.weight, min(b.startdate) as startdate, max(b.enddate) as enddate, sum(b.baseline) as baseline FROM maindata z inner join cam_activity a on (z.itemid=a.caid) inner join activity b on (a.activityid=b.aid) inner join mildata c on (b.itemid=c.itemid AND b.rid=c.rid) where caid=".$data_level_id." Group by z.itemid";
$i=0;
$progress=0;
$pcurrent=0;
$pprev=0;
...
$reportquery ="SELECT z.itemid,z.itemname, z.itemcode, z.parentcd,z.activitylevel,z.weight, min(b.startdate) as startdate, max(b.enddate) as enddate, sum(b.baseline) as baseline, b.rid FROM maindata z inner join cam_activity a on (z.itemid=a.caid) inner join activity b on (a.activityid=b.aid) inner join mildata c on (b.itemid=c.itemid AND b.rid=c.rid) where caid=".$data_level_id." Group by z.itemid";
$i=0;
$progress=0;
$pcurrent=0;
$pprev=0;

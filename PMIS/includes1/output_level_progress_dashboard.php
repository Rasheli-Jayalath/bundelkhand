...
"output")
{
//echo GetPlannedQtysOutputLevel($aparentgroup,$aweight);
...
<td style="text-align:right;"><?php echo number_format($planned_progress,2);?></td>
<td style="text-align:right;"><?php echo number_format($till_today_qty,2);?></td>
<td style="text-align:right;"><?php echo number_format(($difference),2);?></td>
<td style="text-align:right;"><?php echo number_format(($require_daily_rate),2);?></td>

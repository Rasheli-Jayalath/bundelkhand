    ...
    <ul>
		...
		{?>
			...
			?>
			 ...
			 <a href="progress_dashboard.php?obj=<?php echo $actdata["itemid"]; ?>" <?php if($sCurPage=='progress_dashboard.php?obj='.$actdata["itemid"]) echo 'class="sel"' ; ?>  target="_blank" class="current">ACT-D</a>
			 <?php
			}
			else
			{
		...
		<li><a href="#" <?php if($sCurPage=='#') echo 'class="sel"' ; ?>  class="current">EVA</a>
        <ul>
        <li>
		<?php  if($eva_flag==1)
		{
		?><a href="../eva_dashboard.php" >EVA-D</a>
		<?php
		}
		else
		{

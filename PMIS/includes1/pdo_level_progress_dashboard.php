<?php 
if($adata["isentry"]==0&& isset($_REQUEST["obj"]) && $_REQUEST["obj"]!=0 && $_REQUEST["obj"]==$data_level_id && $data_level_param ==
"obj")
{?>
...
$(function () {
            ...
            series: [
		{
                ...
                data: [
				<?php //echo GetActualQtysPDOLevel($aparentgroup,$aweight);?>
			...
			,{
                name: 'Planned',
                data: [
				<?php //echo GetPlannedQtysPDOLevel($aparentgroup,$aweight);?>
...
$next_level_id=0;
?>
<?php if($data_level_id!=0&&$data_level_id!=""&&$data_level_param =="obj")
		{

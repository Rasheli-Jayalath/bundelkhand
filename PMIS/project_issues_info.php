...
//===============================================
 ...
 $pdSQL = "SELECT iss_id, pid, iss_no, iss_title, iss_detail, iss_status, iss_action, iss_remarks FROM t012issues where pid=$pid  and iss_status=1 order by iss_no";
...
<div id="content">
  ...
  <th style="text-align:right; color:#FFF"> <?php if($pid != ""&&$pid!=0){?> <a href="project_issues_input.php"  class="button"><?php echo ADD_NEW_REC;?></a>  &nbsp;  <a href="project_issues_archieve.php"  class="button"><?php echo ARCH_ISS; ?></a><?php }?></th>
  </tr>

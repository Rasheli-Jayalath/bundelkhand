...
if($valuestage!="")
{
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (stage  like '%".$valuestage."%' and stage='EVA') ";
		}
		else
		{
		$sCondition=" (stage  like '%".$valuestage."%' and stage='EVA') ";
		}
...
if($valueitemcode!="")
{
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (itemcode  like '%".$valueitemcode."%' and stage='EVA') ";
		}
		else
		{
		$sCondition=" (itemcode  like '%".$valueitemcode."%' and stage='EVA') ";
		}
...
if($valueitemname!="")
{
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (itemname  like '%".$valueitemname."%' and stage='EVA') ";
		}
		else
		{
		$sCondition=" (itemname  like '%".$valueitemname."%' and stage='EVA') ";
		}
...
$valueisentry=0;
		...
		if($sCondition!="")
		{
		$sCondition.=" AND (isentry=$valueisentry and stage='EVA') ";
		}
		else
		{
		$sCondition=" (isentry=$valueisentry and stage='EVA') ";
		}
...
if (strpos($valueweight,'-') === 0) {
	...
	$sCondition.=" AND (weight <= '$expstart' and stage='EVA') ";
	}
	else
	{
	$sCondition= " (weight  <= '$expstart' and stage='EVA') ";
	}
} 
	...
	if($sCondition!="")
	{
	$sCondition.=" AND (weight between ".$expstart." and ".$expend." and stage='EVA') ";
	}
	else
	{
	$sCondition= " (weight between ".$expstart." and ".$expend." and stage='EVA') ";
	}
}	
}
}
...
?>
	...
	<?php
		...
		| <a href="<?php echo $deletelink; ?>?del=<?php echo $itemid;?>" onclick="return confirm('Are you sure you want to delete this EVA and all of its child?')">Delete</a><?php }} ?>
			 ...
			 ?>
<td style=" font-size:10px; color: #000000; background-color: <?php echo $colorr; ?>" ><a href="logeva.php?trans_id=<?php echo $id1; ?>&module=<?php echo $module?>" target="_blank">Log</a></td>
</tr>
<tr>
		<td colspan="9">
			 <?php

...
<tr> 
<td width="20%" align="left" valign="top" style="border-right: solid 1px #ccc;"><div id="wrapper_MemberLogin" style="margin:10px;">
  ...
  <div id="LoginBox" class="borderRound borderShadow" style="padding:10px">
    <form action="progress_dashboard.php" method="post" name="main_dash" id="main_dash" onsubmit="return frmValidate1(this);">

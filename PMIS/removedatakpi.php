...
@require_once("get_url.php");
	 $delsq3="delete from kpi_activity where kpiid=$itemid and activityid=$activityid";
			  ...
			  ?>
			   ...
			   <input type="hidden" value="<?php echo $itemid; ?>" name="txtitemid" id="txtitemid" />
				...
				?>
					...
					<?php 
$sql_b="SELECT a.kaid, b.aid,b.itemid, b.startdate,b.enddate, b.baseline, b.rid FROM `kpi_activity` a inner join activity b on (a.activityid=b.aid) where a.kpiid=".$itemid; 

...
$sql_pro=mysql_query("INSERT INTO t012issues (pid, iss_no, iss_title, iss_detail, iss_status, iss_action, iss_remarks,attachment,iss_date) Values(".$pid.",'".$iss_no."', '".$iss_title."', '".$iss_detail."', '".$iss_status."', '".$iss_action."', '".$iss_remarks."', '".$flink."', '".$iss_date."')");
	if ($sql_pro == TRUE) {
...
$sql_pro="UPDATE t012issues SET iss_no='$iss_no', iss_title='$iss_title', iss_detail='$iss_detail',  iss_status='$iss_status',  iss_action='$iss_action', iss_remarks='$iss_remarks', attachment='$flink', iss_date='$iss_date' where iss_id=$iss_id";
...
$pdSQL1="SELECT iss_id, pid, iss_no, iss_title, iss_detail, iss_status, iss_action, iss_remarks, attachment,iss_date FROM t012issues  where pid = ".$pid." and  iss_id = ".$iss_id;
  ...
  <tr><td><label>Issue Date:</label></td><td><input  type="text" name="iss_date" id="iss_date" value="<?php if(isset($iss_date)&&$iss_date!="0000-00-00"&&$iss_date!="1970-01-01")echo $iss_date; ?>" /></td></tr>
    <tr><td><label><?php echo TITLE;?>:</label></td><td><textarea rows="4" cols="50" name="iss_title"><?php echo $iss_title; ?></textarea></td></tr>
     ...
     <tr><td><label><?php echo DETAIL;?>:</label></td><td>
	  ...
	  <tr><td><label><?php echo STATUS;?>:</label></td><td><input type="radio" id="iss_status" name="iss_status" value="1" checked="checked"/> <?php echo ACTIVE;?> <input type="radio" id="iss_status" name="iss_status" value="0"/> <?php echo INACTIVE;?></td></tr>

...
?>
      ...
      <select  name="component_name" id="component_name" onchange="getSubcomp(this.value)" style="width:200px" disabled="disabled" >
...
?>
<option value="<?php echo $tdata['sub_component_name']; ?>"><?php echo $tdata['sub_component_name']; ?></option>
<?php

 ...
 <span style="float:right; font-size:12px; padding-top:5px; padding-right:3px;color:white; text-decoration:none"><a href="index.php"><img  src="images/home.png"/></a></span>
  ...
  <div id="wrapperPRight">
		...
		<?php echo $objCommon->displayMessage();?>
            &nbsp;&nbsp;&nbsp;To upload photo to following multiple points Click Here:
           <a href="add_bulkimage.php?channel_id=<?php echo $channel_id; ?>&from_kmpost=<?php echo $from_kmpost; ?>&to_kmpost=<?php echo $to_kmpost; ?>&detail=<?php echo $detail; ?>" style="text-decoration:none; font-weight:bold" target="_blank"><?php echo " Upload Photos"; ?></a>
           <br />
            &nbsp;&nbsp;&nbsp;To upload report to following multiple points Click Here:
           <a href="add_bulkreports.php?channel_id=<?php echo $channel_id; ?>&from_kmpost=<?php echo $from_kmpost; ?>&to_kmpost=<?php echo $to_kmpost; ?>&detail=<?php echo $detail; ?>" style="text-decoration:none; font-weight:bold" target="_blank"><?php echo " Upload Reports"; ?></a>

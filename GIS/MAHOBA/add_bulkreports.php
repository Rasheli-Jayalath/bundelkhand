...
$old_al_file= $pdData["item_name"];
    ...
    $message= mysql_error($db);
						...
						redirect('add_bulkreports.php?channel_id='.$channel_id.'&from_kmpost='.$from_kmpost.'&to_kmpost='.$to_kmpost.'&detail='.$detail);
					}				
...
?>
                <td><a href="add_bulkreports.php?attrib_gallery_id=<?php echo $row4['attrib_gallery_id'];?>&unique_id=<?php echo $row4['oid']?>&channel_id=<?php echo $channel_id; ?>&from_kmpost=<?php echo $from_kmpost; ?>&to_kmpost=<?php echo $to_kmpost; ?>&detail=<?php echo $detail; ?>" title="<?php echo EDIT?>"><img src="<?php echo SITE_URL;?>images/edit.gif" border="0" /></a></td>
                <td><a href="add_bulkreports.php?mode=delete&attrib_gallery_id=<?php echo $row4['attrib_gallery_id'];?>&unique_id=<?php echo $row4['oid']?>&channel_id=<?php echo $channel_id; ?>&from_kmpost=<?php echo $from_kmpost; ?>&to_kmpost=<?php echo $to_kmpost; ?>&detail=<?php echo $detail; ?>" onClick="return confirm('Are you sure you want to delete this image?');" title="<?php echo DELETE?>" name="<?php echo DELETE?>"><img src="<?php echo SITE_URL;?>images/delete.gif" border="0" alt="<?php echo DELETE?>" title="<?php echo DELETE?>" /></a></td>
                <?php
				}
				?>
    		</tr>

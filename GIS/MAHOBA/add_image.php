...
$old_al_file= $pdData["item_name"];
    ...
    $message= mysql_error($db);
						...
						redirect('add_image.php?unique_id='.$unique_id);
					}				
...
?>            
                <td><a href="add_image.php?attrib_gallery_id=<?php echo $row4['attrib_gallery_id'];?>&unique_id=<?php echo $row4['oid']?>" title="<?php echo EDIT;?>"><img src="<?php echo SITE_URL;?>images/edit.gif" border="0" /></a></td>
                <td><a href="add_image.php?mode=delete&attrib_gallery_id=<?php echo $row4['attrib_gallery_id'];?>&unique_id=<?php echo $unique_id ?>" onClick="return confirm('Are you sure you want to delete this image?');" title="<?php echo DELETE;?>" name="delete"><img src="<?php echo SITE_URL;?>images/delete.gif" border="0" alt="Delete" title="<?php echo DELETE;?>" /></a></td>
                <?php
				 }
				 ?>
    		</tr>

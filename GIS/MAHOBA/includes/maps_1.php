...
while($kmldatap=mysql_fetch_array($kmlresultp))
{
	...
	$kmlid=$kmldatap['kid'];
	$kid=$kmlid-1;
	if($file_name=="kainar_index_contours.kml" || $file_name=="kainar_intermediate_contours.kml" || $file_name=="kainar_Canal_Center_Line.kml" 
	|| $file_name=="Sarybulak_index_contours.kml"	|| $file_name=="Sarybulak_intermediate_contours.kml"
	|| $file_name=="Sarybulak_Canal_Center_Line.kml")
	{
		?>
 ...
 ?>  
	...
	<?php $kmlsqlt="select * from  kmls_add where component_name='$componentName'";
...
function placeMarker(position, mapInstance, distance) {
	...
	Ajax = AjaxObject();
		if(Ajax)
		{
			url = "<?php echo $kmlused; ?>buffer_list.php";
...
<ul id="gmaps" style=" background-color:; z-index:1; position: absolute; left: 0%; top: 6%; width: 30%; transform: translate(0px, 0px);
border-radius: 10px; height:50px; width:450px; margin-left:13px;">
<li><a href="qrdash-home.php?map_id=3"> <?php echo SATELLITE?></a></li>
<li ><a href="qrdash-home.php?map_id=2"><?php echo HYBRID?></a></li><li>
 <li ><a href="qrdash-home.php?map_id=1"><?php echo ROADMAP?></a></li>
<li><a href="qrdash-home.php?map_id=4"> <?php echo TERRAIN?></a></li>
</ul>

<div id="maincol" style="margin-left:1px; height:650px;">
			<div id="map" style="float:left; height:650px">
            <div style="background-color:#060; height:100px; width:50px"></div>
            </div>
...
<?php /*?><div id="mainTable" style="margin-left:55px; width:89%">
	...
	<table cellspacing="0" cellpadding="0" border="1px"  align="center" width="100%" style="font-family:Verdana, Geneva, sans-serif; font-size:11px; margin-top:20px;">
     
      <tr style="font-family:Verdana, Geneva, sans-serif; font-size:11px; font-weight:bold; background-color:#0CF">
        <td colspan="3" width="810" align="center" height="30px">Status of Water Supply Schemes</td>
      </tr>
      <tr style="font-family:Verdana, Geneva, sans-serif; font-size:11px; font-weight:bold; background-color:#85bc40; height:23px">
...
<?php
 $iCount = 0;
   ...
   $res_sql= mysql_query($SQL);
    ...
    ?>
    <table cellspacing="0" cellpadding="0" border="1px"  align="center" style="font-family:Verdana, Geneva, sans-serif; font-size:11px; margin-top:20px; width:100%">
...
?>
      <tr>
        <td width="250" align="left" style="font-family:Verdana, Geneva, sans-serif; font-size:11px; font-weight:bold;height:23px; background-color:#85bc40;"><a href="qrdash-home.php?behavid=<?php echo $behavid ?>&componentid=<?php echo $ress['dcode'] ?>&subcomponentid=<?php echo $ress['tcode'] ?>&activityid=<?php echo $ress['vcode'] ?>" target="_blank" style="color:black; font-weight:normal"><? echo $ress['wssname']?></a></td>

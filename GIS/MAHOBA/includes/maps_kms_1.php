...
<li><a href="qrdash-home-km.php?map_id=3&kmpost=<?php echo $kmpost;?>"> <?php echo SATELLITE?></a></li>
<li ><a href="qrdash-home-km.php?map_id=2&kmpost=<?php echo $kmpost;?>"><?php echo HYBRID?></a></li><li>
 <li ><a href="qrdash-home-km.php?map_id=1&kmpost=<?php echo $kmpost;?>"><?php echo ROADMAP?></a></li>
<li><a href="qrdash-home-km.php?map_id=4&kmpost=<?php echo $kmpost;?>"> <?php echo TERRAIN?></a></li>
</ul>
<div id="maincol" style="margin-left:1px; height:650px; width:1348px">
			<div id="map" style="float:left; height:650px; width:1348px" ></div>

  ...
  var createMarker = function (placemark, doc) {
    ...
    if (!parserOptions.suppressInfoWindows) {
      ...
      google.maps.event.addListener(marker, 'click', function() {
		  var gps_data=placemark.description; 
	 // $(function () {
    var rawString = gps_data;
    var cleanString = $(rawString).find('td:eq(5)').text(); // ... or .text()
	var gpsdata='https://india-sdms.smecnet.com/bundelkhand/GIS/MAHOBA/detail_link.php?unique_id=' + cleanString;
	//alert(cleanString); 
		  window.open(gpsdata,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,');
...
var createPolyline = function(placemark, doc) {
  ...
  if (!parserOptions.suppressInfoWindows) {
	...
	var gpsdata='https://india-sdms.smecnet.com/bundelkhand/GIS/MAHOBA/detail_link.php?unique_id=' + cleanString;
	//alert(cleanString); 
		  window.open(gpsdata,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=700,height=500');
		// window.location.href = 'http://www.google.com';
        this.infoWindow.close();
...
var vcode=cleanString.substring(4,15);
	 ...
	 var giscode='http://www.egcpakistan.com/SaafPani/qrdash-home.php?map_id=3&componentid=' + dcode + '&subcomponentid=' + tcode +'&activityid='+ vcode +'&behavid=3';

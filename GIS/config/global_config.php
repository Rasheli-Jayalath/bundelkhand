...
$_CONFIG['site_name'] 			= "Bundelkhand GIS DASHBOARD";
$_CONFIG['site_short_name'] 	= "Bundelkhand GIS DASHBOARD";

$_CONFIG['admin_email'] 		= "tahira.nasreen@smec.com";

if($_SERVER['HTTP_HOST'] == "india-sdms.smecnet.com")
{# For local
	$_CONFIG['site_url'] 		= "https://".$_SERVER['HTTP_HOST']."/bundelkhand/GIS/";
	$_CONFIG['site_path'] 		= $_SERVER['DOCUMENT_ROOT'] . "/bundelkhand/GIS/";
}
else if($_SERVER['HTTP_HOST'] == "localhost" || $_SERVER['HTTP_HOST'] == "14.141.114.205" || $_SERVER['HTTP_HOST'] == "10.100.65.117")
{# For local
	$_CONFIG['site_url'] 		= "http://".$_SERVER['HTTP_HOST']."/bundelkhand/GIS/";
	$_CONFIG['site_path'] 		= $_SERVER['DOCUMENT_ROOT'] . "/bundelkhand/GIS/";
}

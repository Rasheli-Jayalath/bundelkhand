...
if($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	//KAPAl
	$kapal			= $_POST["kapal"];
	$kapaladm 		= $_POST['kapaladm'];
	$kapalentry 		= $_POST['kapalentry'];
	...
	if($flag != false){
		...
		//KAPAL
		$objAdminUser->setProperty("kapal", $kapal);
		$objAdminUser->setProperty("kapaladm", $kapaladm);
		$objAdminUser->setProperty("kapalentry", $kapalentry);
	}
...
<div id="wrapperPRight">
	...
	<?php echo $objCommon->displayMessage();?>
		...
		<input type="radio" id="user_type" name="user_type" value="1" checked="checked" onclick="all_rights()"/>
            ...
            <table width="97%"   border="0" align="left"   class="reference">
			 <tr>
    <td align="right">&nbsp;</td>
    <td width="87" valign="middle">Mahoba</td>
    ...
    <td width="84" align="right"  >Mahoba Entry</td>
    ...
    <td width="85" valign="middle"  >Mahoba Admin</td>
...
<?php /*?>    <tr>
    <td align="right">&nbsp;</td>
    <td width="87" valign="middle">KAPAL</td>
    <td width="79"  ><select name="kapal" id="kapal">
      <option value="0" <?php if ($kapal==0) {echo "selected='selected'";} ?>>Deny</option>
      <option value="1" <?php if ($kapal==1) {echo "selected='selected'";} ?>>Allow</option>
    </select></td>
    
    <td width="84" align="right"  >KAPAL Entry</td>
    <td width="79"  ><select name="kapalentry" id="kapalentry">
      <option value="0" <?php if ($kapalentry==0) {echo "selected='selected'";} ?>>Deny</option>
      <option value="1" <?php if ($kapalentry==1) {echo "selected='selected'";} ?>>Allow</option>
    </select></td>
    <td width="85" valign="middle"  >KAPAL Admin</td>
    <td  ><select name="kapaladm" id="kapaladm">
      <option value="0" <?php if ($kapaladm==0) {echo "selected='selected'";} ?>>Deny</option>
      <option value="1" <?php if ($kapaladm==1) {echo "selected='selected'";} ?>>Allow</option>
    </select></td>

...
//KAPAL
 $kapal_flag 		= $_SESSION['ne_kapal'];
$kapaladm_flag 	= $_SESSION['ne_kapaladm'];
$kapalentry_flag = $_SESSION['ne_kapalentry'];
...
<?php /*?><li align-text="right" style="float:right; "><a href="<?php echo $eng_url; ?>language=rus"><img src="images/russian.png" title="Russian" alt="Russian" /></a></li><?php */?>
 </ul>

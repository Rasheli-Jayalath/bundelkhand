...
.LayoutFrame { margin: 0 auto; width: 100%; display: block; }
	...
	.About_sec .Tabside .Description p .cyan { font-size: 16px; color: #08c2ff; 
		...
		footer { overflow: hidden; width: 1348px; text-align: center; background: rgba(0, 0, 0, 0.6); }
		footer .Cntr {}
...
<?php /*?>	<!-- start footer -->         
	...
	<div align="center" style="margin-top:100px; color:#000">
		&copy;
...
&nbsp;
<?php print " Punjab Saaf Pani";?> </div>
	<!--  end footer-left --><?php */?>
                        ...
                        <div class="Cntr">                
                            <p>COPYRIGHT © SMEC International Pty Ltd. </p>
                        </div>
                    </footer>

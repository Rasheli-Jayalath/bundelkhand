...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
		...
		$report_cd = ($_POST['mode'] == "U") ? $_POST['report_cd'] : $objAdminUser->genCode("rs_tbl_dailyReports", "report_cd");		
	...
	($_FILES["reportfile"]["type"] == "text/plain") || ($_FILES["reportfile"]["type"] == "image/jpg")|| 
		...
		if($objNews->actReport($_POST['mode'])){
			$objCommon->setMessage('Daily Report is saved successfully.','Info');
...
<div id="wrapperPRight">
		<div id="pageContentName" class="shadowWhite"><?php echo ($mode == "U") ? 'Application &raquo; Edit Report' : 'Application &raquo; Add Report';?></div>
		...
		<div class="clear"></div>			
			...
			<div class="clear"></div>
			<div class="formfield b shadowWhite"><?php echo 'Report Date';?> <span style="color:#FF0000;">*</span>:</div>
			<div class="formvalue">

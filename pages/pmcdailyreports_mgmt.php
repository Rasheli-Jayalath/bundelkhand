...
if($_GET['mode'] == 'delete'){
	$objNews->setProperty('report_cd', $_GET['report_cd']);
	 $sql_ii="SELECT * FROM `rs_tbl_dailyReportspmc` where report_cd='$_GET[report_cd]'"; 
		$sql_newi=mysql_query($sql_ii);
		$sql_resnew=mysql_fetch_array($sql_newi);
		if($sql_resnew['reportfile']!="")
		{
		@unlink(DAILYPMCREPORT_PATH . $sql_resnew['reportfile']);
		}
		
	$objNews->actPMCReport('D');
...
<div id="wrapperPRight">
		<div id="pageContentName"><?php echo "PMC Progress Reports Management";?></div>
		...
		<div id="pageContentRight">
			<div class="menu1">
				...
				{
				?>
				<li><a href="./?p=pmcdailyreports_form&amp;mode=add" class="lnkButton"><?php echo "Add New PMC Report";?>
					</a></li>
				<?php
				}
				?>
        ...
        <thead>
                                <tr>
                                  ...
                                  <th width="15%" style="text-align:center; font-size:13px;">District</th>
                                  <th width="15%" style="text-align:center; font-size:13px;">Water Scheme</th>
                                  <th width="15%" style="text-align:center; font-size:13px;">Title</th>
                                  <th width="18%" style="text-align:center;font-size:13px;">Report Date</th>
                                  <th width="15%" style="text-align:center;font-size:13px;">File</th>
	...
	if($objNews->totalRecords() >= 1){
		...
		while($rows = $objNews->dbFetchArray(1)){
            ...
            <tr>
                          ...
                          <td align="left" style="font-size:13px"><?php echo $rows['dname'];?></td>
                          <td align="left" style="font-size:13px"><?php echo $rows['ws_name'];?></td>
                          ...
                          <a href="<?php echo DAILYPMCREPORT_URL.$rows['reportfile'];?>" target="_blank">
                          <img src="images/pdf.png" width="30" height="30"/></a></td>
                           ...
                           <?php if($newsentry_flag==1 || $newsadm_flag==1)
								 {
								   ?>
						    <a href="./?p=pmcdailyreports_form&mode=edit&report_cd=<?php echo $rows['report_cd'];?>" style="text-decoration:none"title="Edit">Edit</a>
						   ...
						   <?php  
							...
							if($newsadm_flag==1)
								  {
								   ?>
								    | <a onClick="return doConfirm('Are you sure to delete this report?');" href="./?p=pmcdailyreports_mgmt&mode=delete&report_cd=<?php echo $rows['report_cd'];?>" style="text-decoration:none" title="Delete">Delete</a>
						   <?php
						   }
						   ?>
						 </td> 

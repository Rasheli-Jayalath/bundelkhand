...
$_CONFIG['site_name'] 			= "bundelkhand";
$_CONFIG['site_short_name'] 	= "bundelkhand";
...
if($_SERVER['HTTP_HOST'] == "india-sdms.smecnet.com")
	...
	$_CONFIG['site_url'] 		= "https://".$_SERVER['HTTP_HOST']."/bundelkhand/";
	$_CONFIG['site_path'] 		= $_SERVER['DOCUMENT_ROOT'] . "/bundelkhand/";
}
else if($_SERVER['HTTP_HOST'] == "localhost" || $_SERVER['HTTP_HOST'] == "14.141.114.205" || $_SERVER['HTTP_HOST'] == "10.100.65.117")
	{

	$_CONFIG['site_url'] 		= "http://".$_SERVER['HTTP_HOST']."/bundelkhand/";
	$_CONFIG['site_path'] 		= $_SERVER['DOCUMENT_ROOT'] . "/bundelkhand/";
}
...
$_CONFIG['report_url']   = $_CONFIG['site_url'] . "Reports/";
$_CONFIG['report_path']  = $_CONFIG['site_path'] . "Reports/";
$_CONFIG['dailypmcreport_url']   = $_CONFIG['site_url'] . "DailyPMCReports/";
$_CONFIG['dailypmcreport_path']  = $_CONFIG['site_path'] . "DailyPMCReports/";
